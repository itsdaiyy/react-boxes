    ...
    <>
      ...
      <div className="relative mx-auto flex justify-between lg:h-[700px] lg:flex-row">
        ...
        {isSideBar ? (
          ...
          isLg={isLg}
          markerRefs={markerRefs}></MapSideBar>
        ...
        {/* Map */}
        <MapBox stations={stations}
          setPopupStation={setPopupStation} isLg={isLg} setClickedId={setClickedId} setIsStationInfo={setIsStationInfo}
          setIsSideBar={setIsSideBar} mapRef={mapRef} markerRefs={markerRefs} popupStation={popupStation}
          setUserLocation={setUserLocation} isSideBar={isSideBar}></MapBox>
