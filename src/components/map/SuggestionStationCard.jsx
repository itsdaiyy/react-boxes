...
import { getPendingBoxes, countRecyclableBoxes, countPendingBoxes, formatPhoneNumber } from "@/utils/helpers";


export default function SuggestionStationCard  ({station, setClickedId, mapRef, setIsStationInfo, isLg, setIsSideBar, markerRefs, setPopupStation,}) {
